...
})({"tdwtT":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "0c3bb59da370799e";
"use strict";
...
const connectedListener = (packet)=>{
    ...
    if (!(0, _mainGameJs.hasLoaded)()) {
        ...
        */ (0, _mainGameJs.setNumberChests)(packet.checked_locations.length + packet.missing_locations.length);
    ...
    */ (0, _mainGameJs.setupDisconnectButton)();
};
const disconnectedListener = ()=>{
    // Add a "you've been disconnected" message to the chat log.
    (0, _textClientJs.addPlainTextToLog)("Disconnected from the server.");
    ...
    (0, _mainGameJs.setupReconnectButton)();
};
...
const locationsCheckedListener = (locations)=>{
    ...
    */ for(var i = 0; i < locations.length; i++){
    ...
    (0, _mainGameJs.updateGoalMessage)();
...
},{"./login.js":"ly455","./mainGame.js":"6me0k","./textClient.js":"6qtxO","./win.js":"jSjH5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ly455":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _jqueryDefault.default)(()=>{
    ...
    */ (0, _jqueryDefault.default)("#host-port-input").val(localStorage.getItem("host-port"));
    (0, _jqueryDefault.default)("#slot-name-input").val(localStorage.getItem("slot-name"));
    (0, _jqueryDefault.default)("#password-input").val(localStorage.getItem("password"));
    // Connect to the server when the login button is clicked.
    (0, _jqueryDefault.default)("#login-submit").on("click", ()=>{
        /*
        ...
        */ (0, _jqueryDefault.default)("#login-submit").prop("disabled", true);
        (0, _jqueryDefault.default)("#login-submit").hide();
        (0, _jqueryDefault.default)("#error-message").text(""); // Empty out the error message so screen readers don't "see" it anymore.
        (0, _jqueryDefault.default)("#error-message").hide();
        (0, _jqueryDefault.default)("#login-loader").show();
        (0, _jqueryDefault.default)("#login-loader-toast").text("Loading..."); // Notifies screen readers that the page is loading.
        var connectionInfo = {
            hostport: (0, _jqueryDefault.default)("#host-port-input").val(),
            game: "Chests 'n' Keys",
            slot: (0, _jqueryDefault.default)("#slot-name-input").val(),
            password: (0, _jqueryDefault.default)("#password-input").val(),
            items_handling: 7
        };
        ...
        client.login(connectionInfo.hostport, connectionInfo.slot, connectionInfo.game, {
            ...
            (0, _jqueryDefault.default)("#login-loader-toast").text(""); // Make it so the screen reader will no longer say that the game is loading.
            (0, _jqueryDefault.default)("#login-container").hide();
            // Notify screen reader users that login was successful.
            (0, _jqueryDefault.default)("#login-success-toast").text("Login successful!");
            // This toast message should disappear after 5 seconds.
            setTimeout(()=>{
                (0, _jqueryDefault.default)("#login-success-toast").text("");
            }, 5000);
            ...
            if (error.errors) {
                ...
                switch(errorType){
                    case "InvalidSlot":
                        (0, _jqueryDefault.default)("#error-message").text("Invalid slot name.");
                        break;
                    case "InvalidPassword":
                        (0, _jqueryDefault.default)("#error-message").text("Incorrect password.");
                        break;
                    default:
            ...
            (0, _jqueryDefault.default)("#login-submit").show();
            (0, _jqueryDefault.default)("#login-submit").prop("disabled", false);
        });
    });
    // Now that the text fields and login button are ready, it's safe to display the login menu.
    (0, _jqueryDefault.default)("#login-container").show();
});

},{"jquery":"hgMhh","archipelago.js":"ka5Bw","./listeners.js":"8WNDW","./win.js":"jSjH5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports,__globalThis) {
/*!
...
},{}],"ka5Bw":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
        ...
        */ try {
        /*
            ...
            */ if (!hasWon) {
            ...
            if ((0, _settingsJs.areAnimationsEnabled)()) (0, _jqueryDefault.default)("#win-text").attr("class", "animated-text");
            ...
            /*
                ...
                */ (0, _jqueryDefault.default)("#win-text").text("U R WINNAR!!!1");
            ...
            var audioToPlay = document.getElementById("win-sound");
            audioToPlay.volume = (0, _settingsJs.getVolume)();
            if ((0, _settingsJs.areSoundsEnabled)()) audioToPlay.play();
            ...
            (0, _jqueryDefault.default)("#win-x").on("click", hideWinMessage);
        }
    } catch (error) {
...
},{"jquery":"hgMhh","./login.js":"ly455","./mainGame.js":"6me0k","./settings.js":"hHf3b","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6me0k":[function(require,module,exports,__globalThis) {
/*
 ...
 * 
 * @returns whether or not the main game screen has finished loading
 */ parcelHelpers.export(exports, "hasLoaded", ()=>hasLoaded);
 ...
 */ parcelHelpers.export(exports, "setupDisconnectButton", ()=>setupDisconnectButton);
/**
 ...
 * and the disconnect/reconnect button is disabled.
 */ parcelHelpers.export(exports, "setupReconnectButton", ()=>setupReconnectButton);
...
*/ parcelHelpers.export(exports, "updateGoalMessage", ()=>updateGoalMessage);
...
// @ts-ignore
var _apIconProgressionSvg = require("bundle-text:../../assets/images/AP Icon progression.svg");
var _apIconProgressionSvgDefault = parcelHelpers.interopDefault(_apIconProgressionSvg);
// @ts-ignore
var _keySvg = require("bundle-text:../../assets/images/Key.svg");
var _keySvgDefault = parcelHelpers.interopDefault(_keySvg);
// @ts-ignore
var _poopSvgrepoComSvg = require("bundle-text:../../assets/images/poop-svgrepo-com.svg");
var _poopSvgrepoComSvgDefault = parcelHelpers.interopDefault(_poopSvgrepoComSvg);
...
function setupMainGameContainer() {
    ...
    for(var i = 1; i <= numberChests; i++){
        ...
        (0, _jqueryDefault.default)(chest).attr("id", "chest" + i);
        // Add a button to the li to make it clickable and keyboard focusable.
        var button = document.createElement("button");
        (0, _jqueryDefault.default)(button).attr("id", "chest-button-" + i);
        (0, _jqueryDefault.default)(chest).append(button);
        // Add a number label to the button.
        var label = document.createElement("span");
        (0, _jqueryDefault.default)(label).text(i);
        ...
        (0, _jqueryDefault.default)(chest).css("fill", chestColor);
        // Set the number label's color so that it has sufficient contrast with its chest.
        (0, _jqueryDefault.default)(label).css("color", getLabelColorForChest(i));
        // Also set the label's background color so that ANDI won't complain.
        (0, _jqueryDefault.default)(label).css("background-color", chestColor);
        /*
        ...
        */ (0, _jqueryDefault.default)("#locations-list").append(chest);
        ...
        if (!doesChestStartLocked(i) || (0, _loginJs.client).items.received.map((item)=>item.id).includes(ITEM_ID_PREFIX + i)) displayChestUnlocked(i);
            ...
            let tooltip = "Chest " + i + " (Locked)";
            (0, _jqueryDefault.default)(chest).attr("title", tooltip);
            // Disable the button
            (0, _jqueryDefault.default)(button).prop("disabled", true);
            // Add the SVG icon inside of the button. We have to make a copy each time.
            (0, _jqueryDefault.default)(button).append((0, _lockedChestSvgDefault.default));
            // Create alt text for the SVG
            let titleElem = document.createElement("title");
            (0, _jqueryDefault.default)(titleElem).text(tooltip);
            let svgElem = (0, _jqueryDefault.default)(button).children("svg")[0]; // The SVG inside of the button
        ...
        (0, _jqueryDefault.default)("#main-game-container").show();
    }
...
function setupDisconnectButton() {
    let disconnectReconnectButton = (0, _jqueryDefault.default)("#disconnect-reconnect-button");
    (0, _jqueryDefault.default)(disconnectReconnectButton).prop("disabled", false);
    (0, _jqueryDefault.default)(disconnectReconnectButton).text("Disconnect");
    (0, _jqueryDefault.default)(disconnectReconnectButton).prop("onclick", null).off("click"); // Remove any existing onclick function.
    (0, _jqueryDefault.default)(disconnectReconnectButton).on("click", ()=>{
        (0, _jqueryDefault.default)(disconnectReconnectButton).prop("disabled", true);
        (0, _loginJs.client).socket.disconnect();
    });
}
function setupReconnectButton() {
    let disconnectReconnectButton = (0, _jqueryDefault.default)("#disconnect-reconnect-button");
    (0, _jqueryDefault.default)(disconnectReconnectButton).prop("disabled", false);
    (0, _jqueryDefault.default)(disconnectReconnectButton).text("Reconnect");
    (0, _jqueryDefault.default)(disconnectReconnectButton).prop("onclick", null).off("click"); // Remove any existing onclick function.
    (0, _jqueryDefault.default)(disconnectReconnectButton).on("click", ()=>{
        (0, _jqueryDefault.default)(disconnectReconnectButton).prop("disabled", true);
        /*
        ...
        */ const reconnectingMessage = "Trying to reconnect to the server...";
        (0, _textClientJs.addPlainTextToLog)(reconnectingMessage);
        // Log back into the game.
        let connectionInfo = {
            hostport: localStorage.getItem("host-port"),
            game: "Chests 'n' Keys",
            slot: localStorage.getItem("slot-name"),
            password: localStorage.getItem("password")
        };
        (0, _loginJs.client).login(connectionInfo.hostport, connectionInfo.slot, connectionInfo.game, {
            password: connectionInfo.password
        }).catch((error)=>{
            /*
            ...
            */ const failedMessage = "Failed to reconnect to the server.";
            (0, _textClientJs.addPlainTextToLog)(failedMessage);
            alert(failedMessage);
 ...
 */ function getHueForChest(chestNumber) {
 ...
 */ function getLabelColorForChest(chestNumber) {
    ...
    */ if (chestHue >= 235 && chestHue <= 251) return "white";
    else return "black";
}
...
function displayLocationChecked(locationId) {
    ...
    (0, _jqueryDefault.default)(chestButtonID + " svg").remove();
    // Return the cursor to normal. (It was a pointer before, to show that this was clickable.)
    (0, _jqueryDefault.default)(chestButtonID).attr("class", null);
    // Change the tooltip
    let tooltip = "Chest " + chestNumber + " (Empty)";
    (0, _jqueryDefault.default)(chestButtonID).attr("title", tooltip);
    // Remove the click function.
    (0, _jqueryDefault.default)(chestButtonID).prop("onclick", null).off("click");
    (0, _jqueryDefault.default)(chestButtonID).prop("disabled", true);
    // Put the SVG tag inside of the li.
    (0, _jqueryDefault.default)(chestButtonID).append((0, _emptyChestSvgDefault.default));
    // Add alt text to the SVG
    let titleElem = document.createElement("title");
    (0, _jqueryDefault.default)(titleElem).text(tooltip);
    let svgElem = (0, _jqueryDefault.default)(chestButtonID).children("svg")[0];
    // For some reason, it's possible for svgElem to be undefined. We have to account for that possibility.
    if (svgElem != undefined) (0, _jqueryDefault.default)(svgElem).append(titleElem);
...
function displayChestUnlocked(chestNumber) {
    ...
    let tooltip = "Chest " + chestNumber + " (Unlocked)";
    (0, _jqueryDefault.default)(chestButtonID).attr("title", tooltip);
    // main-game.css gives all "clickable"-class objects a pointer cursor to show they can be clicked.
    (0, _jqueryDefault.default)(chestButtonID).attr("class", "clickable");
    // Now that the chest is unlocked, clicking it should send a check.
    var chestLocationID = LOCATION_ID_PREFIX + chestNumber;
    (0, _jqueryDefault.default)(chestButtonID).on("click", ()=>{
        (0, _loginJs.client).check(chestLocationID);
    });
    (0, _jqueryDefault.default)(chestButtonID).prop("disabled", false);
    // Add the SVG icon.
    (0, _jqueryDefault.default)(chestButtonID).append((0, _unlockedChestSvgDefault.default));
...
function playSound(soundURL) {
    ...
    */ const MAX_NUMBER_SOUNDS = 5;
    if (document.getElementsByTagName("audio").length >= MAX_NUMBER_SOUNDS) return;
    /*
    ...
    */ var audioToPlay = document.createElement("audio");
    ...
    (0, _jqueryDefault.default)(audioSource).attr("src", soundURL);
    // Use the extension to determine the audio type.
    var urlSplitByDot = soundURL.split(".");
    var fileExtension = urlSplitByDot[urlSplitByDot.length - 1];
    switch(fileExtension){
        case "mp3":
            (0, _jqueryDefault.default)(audioSource).attr("type", "audio/mpeg");
            break;
        case "wav":
            (0, _jqueryDefault.default)(audioSource).attr("type", "audio/wav");
            break;
        default:
    ...
    (0, _jqueryDefault.default)(audioToPlay).text("Your browser does not support the audio element.");
    // Add the audio source to the audio.
    (0, _jqueryDefault.default)(audioToPlay).append(audioSource);
    ...
    */ audioToPlay.addEventListener("ended", (event)=>{
        (0, _jqueryDefault.default)(event.target).remove();
    });
    // Add the audio source to the HTML page so that it will work.
    (0, _jqueryDefault.default)("#audio-container").append(audioToPlay);
    // It's playtime! :D
    audioToPlay.play();
}
function updateIcon() {
    ...
    if (iconRed) (0, _jqueryDefault.default)("#website-icon").attr("href", "assets/images/Red Chest.svg");
    else (0, _jqueryDefault.default)("#website-icon").attr("href", "assets/images/Unlocked Chest.svg");
}
function updateGoalMessage() {
    let newGoalMessage = "You need to open <b>";
    newGoalMessage += numberRequiredChests;
    newGoalMessage += "</b> chests in order to goal. So far, you have opened <b>";
    newGoalMessage += (0, _loginJs.client).room.checkedLocations.length;
    newGoalMessage += "</b>.";
    (0, _jqueryDefault.default)("#goal-message").html(newGoalMessage);
}
function displayItemSent(locationID) {
    // If animations are disabled, this function should do nothing.
    if (!(0, _settingsJs.areAnimationsEnabled)()) return;
    ...
    (0, _loginJs.client).scout([
        ...
        */ let svgContainer = document.createElement("div");
        ...
        if (item.game == "Chests 'n' Keys") {
            ...
            if (item.id == ITEM_THAT_DOES_NOTHING_ID) (0, _jqueryDefault.default)(svgContainer).append((0, _poopSvgrepoComSvgDefault.default));
            else {
                (0, _jqueryDefault.default)(svgContainer).append((0, _keySvgDefault.default));
                // Add a label for what number the key is.
                let keyNumber = item.id - ITEM_ID_PREFIX;
                let label = document.createElement("span");
                (0, _jqueryDefault.default)(label).text(keyNumber);
                (0, _jqueryDefault.default)(label).attr("class", "key-label");
                (0, _jqueryDefault.default)(svgContainer).append(label);
                ...
                if (item.receiver.slot == item.sender.slot) {
                    ...
                    let chestColor = (0, _jqueryDefault.default)(chestID).css("fill");
                    // Set the color of the key icon to match
                    (0, _jqueryDefault.default)(svgContainer).css("fill", chestColor);
                    // Set the color of the key's label so that it contrasts enough with the key itself.
                    (0, _jqueryDefault.default)(label).css("color", getLabelColorForChest(keyNumber));
                } else {
                    (0, _jqueryDefault.default)(svgContainer).css("fill", "black");
            ...
            if (item.progression) (0, _jqueryDefault.default)(svgContainer).append((0, _apIconProgressionSvgDefault.default));
            else if (item.trap) {
                // The SVG file being imported shouldn't have its own colors. We want to add our own instead.
                (0, _jqueryDefault.default)(svgContainer).append((0, _apIconColorlessSvgDefault.default));
                (0, _jqueryDefault.default)(svgContainer).css("fill", "red");
            } else if (item.filler) {
                // The SVG file being imported shouldn't have its own colors. We want to add our own instead.
                (0, _jqueryDefault.default)(svgContainer).append((0, _apIconColorlessSvgDefault.default));
                (0, _jqueryDefault.default)(svgContainer).css("fill", "black");
            } else // The normal SVG comes with its own colors.
            (0, _jqueryDefault.default)(svgContainer).append((0, _apIconSvgDefault.default));
        }
        ...
        */ svgContainer.addEventListener("animationend", (event)=>{
        ...
        (0, _jqueryDefault.default)(liID).append(svgContainer);
    }).catch((reason)=>{
        console.warn("Caught an error in displayItemSent()! Reason: " + reason);
    });
}

},{"jquery":"hgMhh","./login.js":"ly455","./settings.js":"hHf3b","bundle-text:../../assets/images/Empty Chest.svg":"66Z07","bundle-text:../../assets/images/Locked Chest.svg":"gUeNL","bundle-text:../../assets/images/Unlocked Chest.svg":"erxC6","bundle-text:../../assets/images/AP Icon.svg":"2U4T9","bundle-text:../../assets/images/AP Icon colorless.svg":"6ZCis","bundle-text:../../assets/images/AP Icon progression.svg":"anuO7","bundle-text:../../assets/images/Key.svg":"4eT6U","bundle-text:../../assets/images/poop-svgrepo-com.svg":"1lMGR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./textClient.js":"6qtxO"}],"hHf3b":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _jqueryDefault.default)(()=>{
    ...
    if (localStorage.getItem("sounds-enabled") == null) {
        soundsEnabled = true;
        (0, _jqueryDefault.default)("#enable-sounds").prop("checked", true);
    } else {
        soundsEnabled = localStorage.getItem("sounds-enabled") == "true";
        (0, _jqueryDefault.default)("#enable-sounds").prop("checked", soundsEnabled);
    }
    if (localStorage.getItem("volume") == null) {
        volume = 1;
        (0, _jqueryDefault.default)("#sound-volume").attr("value", 1);
    } else {
        volume = parseFloat(localStorage.getItem("volume")); // convert string to float
        (0, _jqueryDefault.default)("#sound-volume").attr("value", volume);
    }
    if (localStorage.getItem("animations-enabled") == null) {
        animationsEnabled = true;
        (0, _jqueryDefault.default)("#enable-animations").prop("checked", true);
    } else {
    ...
    (0, _jqueryDefault.default)("#sound-volume").on("change", adjustVolume);
    // Clicking the "Enable animations" checkbox will toggle whether animations are enabled.
    (0, _jqueryDefault.default)("#enable-animations").on("click", toggleAnimationsEnabled);
});
...
module.exports = "<?xml version=\"1.0\" encoding=\"utf-8\"?><!-- Generator: Adobe Illustrator 26.4.1, SVG Export Plug-In . SVG Version: 6.00 Build 0)  --><svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" version=\"1.1\" x=\"0px\" y=\"0px\" viewBox=\"0 0 2034 2112\" style=\"enable-background: new 0 0 2034 2112\" xml:space=\"preserve\">\n<g>\n\t<path d=\"M943.7,755.54c0,23.44-1.51,46.89-4.54,69.58c24.96,4.54,50.67,7.18,77.14,7.18s52.18-2.65,77.14-7.18\r\n\t\tc-3.02-22.69-4.54-46.13-4.54-69.58c0-214.4,128.95-399.31,313.48-480.99C1343.76,118.38,1192.89,7.21,1016.3,7.21\r\n\t\tS688.83,118.38,630.22,274.55C814.75,356.23,943
.42,2.65,40.46,6.43,59.75c3.02,18.91,7.94,37.81,13.99,55.58C679,1987.89,834.04,2107,1016.3,2107\r\n\t\ts337.3-119.11,391.75-283.6c6.05-17.77,10.97-36.68,13.99-55.58c3.78-19.66,6.05-39.7,6.43-60.12c0.38-4.54,0.38-9.07,0.38-13.61\r\n\t\tC1428.84,1533.75,1336.96,1394.21,1202.72,1326.15z\"/>\n</g>\n</svg>";

},{}],"anuO7":[function(require,module,exports,__globalThis) {
module.exports = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?><!-- Generator: Adobe Illustrator 26.4.1, SVG Export Plug-In . SVG Version: 6.00 Build 0)  --><svg xmlns:inkscape=\"http://www.inkscape.org/namespaces/inkscape\" xmlns:sodipodi=\"http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:svg=\"http://www.w3.org/2000/svg\" version=\"1.1\" x=\"0px\" y=\"0px\" viewBox=\"0 0 2034 2112\" style=\"enable-background: new 0 0 2034 2112\" xml:space=\"preserve\" id=\"svg6\" sodipodi:docname=\"AP Icon progression.svg\" inkscape:version=\"1.4.2 (f4327f4, 2025-05-13)\"><defs id=\"defs6\"/><sodipodi:namedview id=\"namedview6\" pagecolor=\"#ffffff\" bordercolor=\"#000000\" borderopacity=\"0.25\" inkscape:showpageshadow=\"2\" inkscape:pageopacity=\"0.0\" inkscape:pagecheckerboard=\"0\" inkscape:deskcolor=\"#d1d1d1\" inkscape:zoom=\"0.14999235\" inkscape:cx=\"953.38197\" inkscape:cy=\"1453.4075\" inkscape:window-width=\"1280\" inkscape:window-height=\"650\" inkscape:window-x=\"-6\" inkscape:window-y=\"-6\" inkscape:window-maximized=\"1\" inkscape:current-layer=\"layer1\"/>\n<style id=\"style1\">.st0 {\n  fill: #c97682;\n}\n\n.st1 {\n  fill: #75c275;\n}\n\n.st2 {\n  fill: #eee391;\n}\n\n.st3 {\n  fill: #ca94c2;\n}\n\n.st4 {\n  fill: #767ebd;\n}\n\n.st5 {\n  fill: #d9a07d;\n}\n</style>\n<g id=\"g6\">\n\t<path class=\"st0\" d=\"M943.7,755.54c0,23.44-1.51,46.89-4.54,69.58c24.96,4.54,50.67,7.18,77.14,7.18s52.18-2.65,77.14-7.18   c-3.02-22.69-4.54-46.13-4.54-69.58c0-214.4,128.95-399.31,313.48-480.99C1343.76,118.38,1192.89,7.21,1016.3,7.21   S688.83,118.38,630.22,274.55C814.75,356.23,943.7,541.14,943.7,755.54z\" id=\"path1\"/>\n\t<path class=\"st1\" d=\"M1202.34,755.54c0,10.59,0.38,21.55,1.51,31.76c1.13,20.04,4.16,39.7,8.32,58.61   c4.16,18.91,9.83,37.06,16.64,54.83c7.18,19.66,15.88,38.19,26.09,56.34c94.16-88.49,220.83-142.93,359.99-142.93   s265.83,54.45,359.98,142.93c33.65-59.75,52.56-128.57,52.56-201.55c0-227.26-184.91-412.55-412.55-412.55   c-26.47,0-52.18,2.65-77.14,7.18c-18.91,3.78-37.44,8.32-55.21,14.75c-18.91,6.05-37.06,13.99-54.83,23.44   C1294.23,456.43,1202.34,595.59,1202.34,755.54z\" id=\"path2\"/>\n\t<path class=\"st2\" d=\"M417.71,814.15c139.15,0,265.83,54.45,359.99,142.93c10.21-18.15,18.91-36.68,26.09-56.34   c6.
.5293 1823.4004 C 678.9993 1987.8904 834.04078 2107 1016.3008 2107 C 1198.5608 2107 1353.6008 1987.8904 1408.0508 1823.4004 C 1409.4184 1819.3835 1410.7275 1815.3076 1411.9707 1811.1875 L 1411.9707 1729.668 L 1315.1934 1729.668 A 100.01 100.01 0 0 1 1232.0957 1574.0352 L 1330.5469 1426.9805 C 1295.2127 1385.4674 1251.7974 1351.0324 1202.7207 1326.1504 C 1184.9507 1317.0804 1166.4209 1309.1309 1147.1309 1302.7109 C 1129.3609 1296.6609 1110.4491 1291.7398 1091.5391 1288.3398 C 1066.9591 1283.7998 1041.9991 1281.5293 1016.2891 1281.5293 z \"/>\n</g>\n<g inkscape:groupmode=\"layer\" id=\"layer1\" inkscape:label=\"Arrow\"><path id=\"rect6\" style=\"fill: #fe0; stroke-width: 22.8843px; fill-opacity: 1; display: inline\" d=\"m 1651.377,1127.5137 -336.1836,502.1543 h 196.7773 v 403.6679 h 278.8145 V 1629.668 h 196.7773 z\"/></g></svg>";
...
},{}],"1lMGR":[function(require,module,exports,__globalThis) {
 ...
 */ parcelHelpers.export(exports, "addPlainTextToLog", ()=>addPlainTextToLog);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
...
function setupTextClient() {
    ...
    (0, _jqueryDefault.default)("#send-chat-submit").on("click", sendChat);
    // Clicking the "Only messages about me" checkbox will toggle whether irrelevant messages are shown.
    (0, _jqueryDefault.default)("#only-relevant-messages").on("click", toggleShowOnlyRelevantMessages);
    // Pressing the Enter key while in the chat text box will send a chat message.
    (0, _jqueryDefault.default)("#send-chat-input").on("keypress", (event)=>{
 ...
 */ function sanitizeText(text) {
    ...
    */ return (0, _jqueryDefault.default)("<p>").text(text).html();
}
function addToLog(message) {
    ...
    for(let i = 0; i < message.length; i++){
        ...
        */ let node = message[i];
        ...
        (0, _jqueryDefault.default)(span).attr("class", spanClass);
        (0, _jqueryDefault.default)(span).attr("title", spanHoverText);
        ...
        for(let i = 0; i < linesOfText.length; i++){
            if (i > 0) (0, _jqueryDefault.default)(span).append(document.createElement("br"));
            // Sanitize each line of text to prevent cross-site scripting!
            (0, _jqueryDefault.default)(span).append(sanitizeText(linesOfText[i]));
        }
        // Add the span to the li.
        (0, _jqueryDefault.default)(li).append(span);
    }
    // If this message is not relevant to the player,
    // give the li the "irrelevant" class so it can be hidden if the user wants.
    if (!isRelevant) {
        (0, _jqueryDefault.default)(li).attr("class", "irrelevant");
        ...
        if (checkbox.checked) (0, _jqueryDefault.default)(li).hide();
    }
    ...
    (0, _jqueryDefault.default)("#log").append(li);
...
function addPlainTextToLog(plainText) {
    // The text will be contained in a span contained in a li.
    let li = document.createElement("li");
    let span = document.createElement("span");
    (0, _jqueryDefault.default)(span).text(plainText);
    (0, _jqueryDefault.default)(li).append(span);
...
function sendChat() {
    ...
    var textbox = (0, _jqueryDefault.default)("#send-chat-input");
...
function toggleShowOnlyRelevantMessages() {
    ...
    (0, _jqueryDefault.default)(".irrelevant").hide();
    else // Otherwise, show the irrelevant log messages again.
    (0, _jqueryDefault.default)(".irrelevant").css("display", "list-item");
}

},{"jquery":"hgMhh","./login":"ly455","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["tdwtT","8WNDW"], "8WNDW", "parcelRequire04ca", {})
