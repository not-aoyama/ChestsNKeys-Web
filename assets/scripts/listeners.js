 ...
 */ function displayToScreenReader(screenReaderMessage) {
    let newToastMsg = document.createElement("p");
    (0, _jqueryDefault.default)(newToastMsg).text(screenReaderMessage);
    (0, _jqueryDefault.default)("#locations-toast").append(newToastMsg);
    setTimeout(()=>{
        newToastMsg.remove();
    }, 2000);
}
...
function displayChestUnlocked(chestNumber) {
    ...
    if (!chestIsEmpty) displayToScreenReader("Chest " + chestNumber + " unlocked!");
}
        ...
        */ let svgContainer = document.createElement("div");
        ...
        if (item.game == "Chests 'n' Keys") {
            ...
            if (item.id == ITEM_THAT_DOES_NOTHING_ID) (0, _jqueryDefault.default)(svgContainer).append((0, _poopSvgrepoComSvgDefault.default));
                ...
                } else (0, _jqueryDefault.default)(svgContainer).css("fill", "black");
            }
        } else {
...
},{"jquery":"hgMhh","./login.js":"ly455","./settings.js":"hHf3b","bundle-text:../../assets/images/Empty Chest.svg":"66Z07","bundle-text:../../assets/images/Locked Chest.svg":"gUeNL","bundle-text:../../assets/images/Unlocked Chest.svg":"erxC6","bundle-text:../../assets/images/AP Icon.svg":"2U4T9","bundle-text:../../assets/images/AP Icon colorless.svg":"6ZCis","bundle-text:../../assets/images/AP Icon progression.svg":"anuO7","bundle-text:../../assets/images/Key.svg":"4eT6U","bundle-text:../../assets/images/poop-svgrepo-com.svg":"1lMGR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hHf3b":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
    ...
    for(let i = 0; i < message.length; i++){
        ...
        */ let node = message[i];
        ...
        for(let i = 0; i < linesOfText.length; i++){
            ...
            (0, _jqueryDefault.default)(span).append(linesOfText[i]);
        }
