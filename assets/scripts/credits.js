...
})({"d3gkE":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "dfb8d3346eb2a4e6";
"use strict";
...
},{}],"i1gTJ":[function(require,module,exports,__globalThis) {
var _jquery = require("jquery");
_jquery(document).ready(()=>{
    // Toggle whether the credits is shown when the credits hyperlink is clicked.
    _jquery("#credits-link").click(()=>{
        // If the settings menu is hidden, show it.
        if (_jquery("#credits-menu").css("display") == "none") _jquery("#credits-menu").show();
        else _jquery("#credits-menu").hide();
    });
    // Hide the settings menu when the X button is clicked.
    _jquery("#credits-x").click(()=>{
        _jquery("#credits-menu").hide();
    });
});
...
},{}]},["d3gkE","i1gTJ"], "i1gTJ", "parcelRequire04ca", {})
