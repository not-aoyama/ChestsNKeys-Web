    ...
    for(var i = 1; i <= numberChests; i++){
        ...
        */ (0, _jqueryDefault.default)("#locations-list").append(chest);
        ...
        if (!doesChestStartLocked(i) || (0, _loginJs.client).items.received.map((item)=>item.id).includes(ITEM_ID_PREFIX + i)) displayChestUnlocked(i);
            ...
            (0, _jqueryDefault.default)(chest).attr("title", "Chest " + i + " (Locked)");
            // Disable the button
...
function displayLocationChecked(locationId) {
    ...
    // Change the tooltip
    (0, _jqueryDefault.default)(chestButtonID).attr("title", "Chest " + chestNumber + " (Empty)");
...
function displayChestUnlocked(chestNumber) {
    ...
    (0, _jqueryDefault.default)(chestButtonID).attr("title", "Chest " + chestNumber + " (Unlocked)");
...
},{"jquery":"hgMhh","./login.js":"ly455","./settings.js":"hHf3b","bundle-text:../../assets/images/Empty Chest.svg":"66Z07","bundle-text:../../assets/images/Locked Chest.svg":"gUeNL","bundle-text:../../assets/images/Unlocked Chest.svg":"erxC6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","bundle-text:../../assets/images/AP Icon.svg":"2U4T9","bundle-text:../../assets/images/AP Icon colorless.svg":"6ZCis","bundle-text:../../assets/images/AP Icon progression.svg":"anuO7","bundle-text:../../assets/images/Key.svg":"4eT6U","bundle-text:../../assets/images/poop-svgrepo-com.svg":"1lMGR"}],"hgMhh":[function(require,module,exports,__globalThis) {
/*!
...
},{"jquery":"hgMhh","./login.js":"ly455","./mainGame.js":"6me0k","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./settings.js":"hHf3b"}],"hHf3b":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
